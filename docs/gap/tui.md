...
- The Rust crate does not implement the full TypeScript terminal diff renderer, overlay stack, image protocols, ANSI-preserving wrapping, autocomplete, stdin buffering, undo stack, or kill ring.
