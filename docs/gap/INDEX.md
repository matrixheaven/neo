...
- OpenAI Responses, Anthropic Messages, Google Generative AI, and
  ...
  `models.json`; Pi pricing metadata, generated catalog sources,
  provider-override migration, auth-file/OAuth flows, and local APIs remain
  catalog/API gaps.
