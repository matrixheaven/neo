...
#[cfg(test)]
#[path = "test_cases/context_paths.rs"]
mod context_paths;

#[cfg(test)]
#[path = "test_cases/shell_failure.rs"]
mod shell_failure;

#[cfg(test)]
#[path = "test_cases/exit_code.rs"]
mod exit_code;

#[cfg(test)]
#[path = "test_cases/resource_limit.rs"]
mod resource_limit;

#[cfg(test)]
#[path = "test_cases/registry.rs"]
mod registry;
