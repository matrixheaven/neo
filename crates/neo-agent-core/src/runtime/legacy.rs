...
use neo_ai::{
    AiError, AiStreamEvent, ChatMessage, ChatRequest, ContentPart, ModelClient,
    RequestOptions, ToolSpec,
};
...
use crate::tools::{normalize_path, execute_model_bash_for_runtime};
use crate::{
    ...
    PermissionOperation, PlanModeGuard, PlanModeInjector, ProcessSupervisor, QueueKind,
    StopReason, TodoEventData, ToolAccess, ToolContext,
    ToolError, ToolRegistry, ToolResult, check_plan_mode_guard,
