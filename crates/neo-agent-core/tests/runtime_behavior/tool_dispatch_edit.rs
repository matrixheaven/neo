...
pub(crate) struct StoreWorkflowDispatchHandleTool {
    pub(crate) slot: Arc<Mutex<Option<WorkflowDispatchHandle>>>,
}
...
pub(crate) struct InvokeStoredWorkflowDispatchHandleTool {
    pub(crate) slot: Arc<Mutex<Option<WorkflowDispatchHandle>>>,
}
...
pub(crate) struct NestedWorkflowEchoTool;
