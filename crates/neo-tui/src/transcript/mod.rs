...
pub(crate) use child_activity::{
    ...
    render_child_agent_summary, render_child_body, render_child_final,
    render_child_instruction_row, render_child_thinking, render_child_tool_row, role_badge_style,
    role_label,
};
